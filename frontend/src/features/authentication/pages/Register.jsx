    ...
    <div className='register-user-container'>
      ...
      <form >
       ...
       <div className='logo'>
        ...
        <svg className='lft-arrow' viewBox="6 0 22 22"  aria-hidden="true">
          <path d = "M16.753 4.341a1 1 0 0 0-1.412-.094l-8 7a1 1 0 0 0 0 1.506l8 7a1 1 0 0 0 1.318-1.506L9.518 12l7.14-6.247a1 1 0 0 0 .094-1.412z"  fill = "#96A6B4">

          </path>
        </svg>

        <svg  className='meta-logo' viewBox='0 0 500 100' >
      ...
      <div className='email-input-container input-container'>
        ...
        <small> You may receive notifications from us. <span>Learn why we ask for your contact information</span> </small>
      ...
      <div className="userName-container input-container">
        ...
        <div className="register-info input-container">
          <p>People who use our service may have uploaded your contact information to Instagram. <span>Learn more.</span></p>
        <p>You may receive SMS from us and can opt out at any time. <span>Learn more.</span> </p>
        </div>
