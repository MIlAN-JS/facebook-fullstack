  ...
  return (
    <nav className='navbar'>
        ...
        <i className='user-profile'>
                <img src="https://i.pinimg.com/736x/0c/16/ad/0c16ad725299f07707c83335c5cb873d.jpg" alt="" />
        </i>
